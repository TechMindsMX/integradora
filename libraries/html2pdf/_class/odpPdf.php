        ...
        if ( strpos($orden->numOrden,'-0') ){
            ...
            <div id="odr_preview">
                <div class="clearfix" id="logo">
                    <div class="span5"><img width="200" src="'.JUri::base().'images/logo_iecce.png'.'" /></div>
                    <div class="span5">
                        <div class="row"><h3 class="span2 text-right" style="width: 40%;">No. Mutuo</h3><h3 class="span2 bordes-box text-center">'.$orden->idMutuo.'</h3></div>
