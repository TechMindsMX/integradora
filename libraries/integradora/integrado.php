...
class IntegradoSimple extends Integrado {
    ...
    public function getCiudad(){
        ...
        switch($this->integrados[0]->integrado->pers_juridica){
            case 2:
                $ciudad = isset($this->integrados[0]->datos_personales->direccion_CP->dCiudad)?$this->integrados[0]->datos_personales->direccion_CP->dCiudad : $this->integrados[0]->datos_personales->direccion_CP->dAsenta;
                break;
            case 1:
                $ciudad = isset($this->integrados[0]->datos_empresa->direccion_CP->dCiudad)?$this->integrados[0]->datos_empresa->direccion_CP->dCiudad : $this->integrados[0]->datos_empresa->direccion_CP->dAsenta;
                break;
        }
