...
?>
        ...
        <?php
        if($this->permisos['canAuth'] && $this->odr->getStatus()->id == 1 ):
            $authorizeURL = JRoute::_('index.php?option=com_mandatos&view=odrpreview&layout=confirmauth&idOrden='.$this->odr->getId());
        ?>
