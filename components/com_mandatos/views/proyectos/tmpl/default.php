...
if( !is_null($proyectos) ){
	$agregarSubproyecto = '<a class="btn btn-primary span3" href="'.JRoute::_('index.php?option=com_mandatos&view=altasubproyectos').'">'.JText::_('COM_PROYECTOS_LISTADO_AGREGAR_SUBPROYECTO').'</a>';
}else{
	$agregarSubproyecto = '';
}
?>
