...
<div>
	<div class="col-md-4">
		<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_mandatos&view=clientesform&integradoId='.$this->integradoId); ?>" /><?php echo JText::_('COM_MANDATOS_CLIENTES_LBL_AGREGAR'); ?></a>
	</div>
