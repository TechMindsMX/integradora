...
<div style="margin-top: 20px;"><a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_mandatos&view=ordencompra&integradoId='.$this->integradoId); ?>" /><?php echo JText::_('COM_MANDATOS_LISTAD_ORDENES'); ?></a></div>
