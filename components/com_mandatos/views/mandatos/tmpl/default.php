...
<div class="margen-fila">
    <a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_mandatos&view=odrlist&integradoId='.$this->integradoId); ?>" />
    <?php echo JText::_('COM_MANDATOS_ORDENES_RETIRO_LISTADO'); ?>
    </a>
</div>
