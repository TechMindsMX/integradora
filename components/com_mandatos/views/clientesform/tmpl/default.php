...
<script>
	...
	function busqueda(){
		...
		resultado.done(function(response){
			...
			if(obj.success){
				mensajes('<?php echo JText::_('MSG_FILL_FORM'); ?>', 'msg');
				llenaForm(obj);
			}else{
				mensajes(obj.msg, 'error')
			}
		});
	}
...
<form action="" class="form" id="altaC_P" name="altaC_P" method="post" enctype="multipart/form-data" >
	...
	<fieldset>
		<div class="form-group">
			<input type="text" name="bu_rfc" id="bu_rfc" /> <span id="errorRFC" style="display: none;"></span>
		</div>
	...
	<fieldset>
		<div class="radio">
			<label><input type="radio" name="typ_tipo_alta" id="tipoAlta0" value="0" ><?php echo JText::_('LBL_CLIENTE'); ?></label>
		</div>
		<div class="radio">
			<label><input type="radio" name="typ_tipo_alta" id="tipoAlta1" value="1" ><?php echo JText::_('LBL_PROVEEDOR'); ?></label>
		</div>
		<div class="radio">
			<label><input type="radio" name="typ_tipo_alta" id="tipoAlta2" value="2" checked="checked" ><?php echo JText::_('LBL_AMBOS'); ?></label>
		</div>
		
		<div id="monto" class="form-inline">
			<label for="typ_monto"><?php echo JText::_('LBL_MONTO'); ?></label>
			<input type="text" name="typ_monto" id="typ_monto" />
		</div>
	</fieldset>
	...
	<fieldset>
		<div class="form-group">
			<label for="nombre"><?php echo JText::_('LBL_NOMBRE_COMPLETO'); ?></label>
			<input name="nombre" type="text" maxlength="50" value="" />
		</div>
		<div class="form-group">
	...
	<fieldset>
		<div class="form-group">
			<label for="dp_nom_comercial1"><?php echo JText::_('LBL_NOM_COMERCIAL'); ?></label>
			<input name="dp_nom_comercial1" id="dp_nom_comercial1" type="text" maxlength="100" />
		</div>
		<div class="form-group">
			<label for="dp_curp1"><?php echo JText::_('LBL_CURP'); ?></label>
			<input name="dp_curp1" id="dp_curp1" type="text" maxlength="18" />
		</div>
		
		<div class="form-group">
			<label for="dp_tel_fijo1"><?php echo JText::_('LBL_TEL_FIJO'); ?> 1</label>
			<input name="dp_tel_fijo1" id ="dp_tel_fijo1" type="text" maxlength="10" />
		</div>
		<div class="form-group">
			<label for="dp_tel_fijo_extension1"><?php echo JText::_('LBL_EXT'); ?> 1</label>
			<input name="dp_tel_fijo_extension1" id="dp_tel_fijo_extension1" type="text" maxlength="5" />
		</div>
		<div class="form-group">
			<label for="dp_tel_movil1"><?php echo JText::_('LBL_TEL_MOVIL'); ?> 1</label>
			<input name="dp_tel_movil1" id ="dp_tel_movil1" type="text" maxlength="13" />
		</div>
		<div class="form-group">
			<label for="email1"><?php echo JText::_('LBL_CORREO'); ?> 1</label>
			<input name="email1" id="dp_email1" type="email" maxlength="100" />
		</div>
		
		<div class="form-group">
			<label for="dp_tel_fijo2"><?php echo JText::_('LBL_TEL_FIJO'); ?> 2</label>
			<input name="dp_tel_fijo2" id ="dp_tel_fijo2" type="text" maxlength="10" />
		</div>
		<div class="form-group">
			<label for="dp_tel_fijo_extension2"><?php echo JText::_('LBL_EXT'); ?> 2</label>
			<input name="dp_tel_fijo_extension2" id="dp_tel_fijo_extension2" type="text" maxlength="5" />
		</div>
		<div class="form-group">
			<label for="dp_tel_movil2"><?php echo JText::_('LBL_TEL_MOVIL'); ?> 2</label>
			<input name="dp_tel_movil2" id ="dp_tel_movil2" type="text" maxlength="13" />
		</div>
		<div class="form-group">
			<label for="email2"><?php echo JText::_('LBL_CORREO'); ?> 2</label>
			<input name="email2" id="dp_email2" type="email1" maxlength="100" />
		</div>
		
		<div class="form-group">
			<label for="dp_tel_fijo3"><?php echo JText::_('LBL_TEL_FIJO'); ?> 3</label>
			<input name="dp_tel_fijo3" id ="dp_tel_fijo3" type="text" maxlength="10" />
		</div>
		<div class="form-group">
			<label for="dp_tel_fijo_extension3"><?php echo JText::_('LBL_EXT'); ?> 3</label>
			<input name="dp_tel_fijo_extension3" id="dp_tel_fijo_extension3" type="text" maxlength="5" />
		</div>
		<div class="form-group">
			<label for="dp_tel_movil3"><?php echo JText::_('LBL_TEL_MOVIL'); ?> 3</label>
			<input name="dp_tel_movil3" id ="dp_tel_movil3" type="text" maxlength="13" />
		</div>
		<div class="form-group">
			<label for="email3"><?php echo JText::_('LBL_CORREO'); ?> 3</label>
			<input name="email3" id="dp_email3" type="email" maxlength="100" />
		</div>
	</fieldset>
	<?php
		echo JHtml::_('bootstrap.endSlide');
