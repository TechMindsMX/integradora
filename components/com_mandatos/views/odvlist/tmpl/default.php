        ...
        if( !is_null($ordenes) ){
            foreach ($ordenes as $key => $value) {
                ...
                if ($value->status->id == 0 && $this->permisos['canAuth']){
                    ...
                    $edit_button = '<a class="btn btn-primary" href="index.php/component/mandatos/?view=odvform&integradoId='.$this->integradoId.'&idOrden='.$value->id.'">'.JText::_('COM_MANDATOS_PROYECTOS_LISTADO_EDITAR_PROYECTO').'</a>';
