...
<form id="generaODC" method="post" action="<?php echo JRoute::_('index.php?option=com_mandatos&view=generarodc&integradoId=1&confirmacion=1') ?>" role="form" enctype="multipart/form-data">
