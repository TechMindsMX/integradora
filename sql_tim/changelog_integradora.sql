...
ALTER TABLE `flpmu_auth_mutuo` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_auth_mutuo_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
ALTER TABLE `flpmu_auth_odc` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_auth_odc_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
ALTER TABLE `flpmu_auth_odd` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_auth_odd_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
ALTER TABLE `flpmu_auth_odr` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_auth_odr_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
ALTER TABLE `flpmu_auth_odv` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_auth_odv_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
ALTER TABLE `flpmu_facturas_comisiones` COLLATE utf8_general_ci, CHANGE COLUMN `integradoId` `integradoId` VARCHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, ADD FOREIGN KEY (`flpmu_facturas_comisiones_ibfk_1`) REFERENCES `flpmu_integrado` (`integradoId`);
...
--rollback ALTER TABLE `flpmu_auth_mutuo` DROP FOREIGN KEY `flpmu_auth_mutuo_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_auth_odc` DROP FOREIGN KEY `flpmu_auth_odc_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_auth_odd` DROP FOREIGN KEY `flpmu_auth_odd_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_auth_odr` DROP FOREIGN KEY `flpmu_auth_odr_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_auth_odv` DROP FOREIGN KEY `flpmu_auth_odv_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_facturas_comisiones` DROP FOREIGN KEY `flpmu_facturas_comisiones_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_clientes_proveedor` DROP FOREIGN KEY `flpmu_integrado_clientes_proveedor_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_Id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_clientes_proveedor` DROP FOREIGN KEY `flpmu_integrado_clientes_proveedor_ibfk_2`, CHANGE COLUMN `integradoIdCliente` `integradoIdCliente` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_comisiones` DROP FOREIGN KEY `flpmu_integrado_comisiones_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_contacto` DROP FOREIGN KEY `flpmu_integrado_contacto_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_datos_bancarios` DROP FOREIGN KEY `flpmu_integrado_datos_bancarios_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_datos_empresa` DROP FOREIGN KEY `flpmu_integrado_datos_empresa_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_datos_personales` DROP FOREIGN KEY `flpmu_integrado_datos_personales_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_instrumentos` DROP FOREIGN KEY `flpmu_integrado_instrumentos_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_params` DROP FOREIGN KEY `flpmu_integrado_params_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_products` DROP FOREIGN KEY `flpmu_integrado_products_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_proyectos` DROP FOREIGN KEY `flpmu_integrado_proyectos_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_status_log` DROP FOREIGN KEY `flpmu_integrado_status_log_ibfk_1`, CHANGE COLUMN `status_log_integrado_id` `status_log_integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_timone` DROP FOREIGN KEY `flpmu_integrado_timone_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_users` DROP FOREIGN KEY `flpmu_integrado_users_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_integrado_verificacion_solicitud` DROP FOREIGN KEY `flpmu_integrado_verificacion_solicitud_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_mandatos_clientes` DROP FOREIGN KEY `flpmu_mandatos_clientes_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_mandatos_mutuos` DROP FOREIGN KEY `flpmu_mandatos_mutuos_ibfk_1`, CHANGE COLUMN `integradoIdE` `integradoIdE` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_mandatos_mutuos` DROP FOREIGN KEY `flpmu_mandatos_mutuos_ibfk_2`, CHANGE COLUMN `integradoIdR` `integradoIdR` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_mandatos_productos` DROP FOREIGN KEY `flpmu_mandatos_productos_ibfk_1`, CHANGE COLUMN `integradoId` `integrado_id` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_ordenes_compra` DROP FOREIGN KEY `flpmu_ordenes_compra_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_ordenes_deposito` DROP FOREIGN KEY `flpmu_ordenes_deposito_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_ordenes_retiro` DROP FOREIGN KEY `flpmu_ordenes_retiro_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_ordenes_venta` DROP FOREIGN KEY `flpmu_ordenes_venta_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_reportes_balance` DROP FOREIGN KEY `flpmu_reportes_balance_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_txs_banco_integrado` DROP FOREIGN KEY `flpmu_txs_banco_integrado_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_txs_liquidacion_saldo` DROP FOREIGN KEY `flpmu_txs_liquidacion_saldo_ibfk_1`, CHANGE COLUMN `integradoId` `integradoId` INT(11) NOT NULL;
--rollback ALTER TABLE `flpmu_txs_timone_mandato` DROP FOREIGN KEY `flpmu_txs_timone_mandato_ibfk_1`, CHANGE COLUMN `integradoId` `idIntegrado` INT(11) NOT NULL;
