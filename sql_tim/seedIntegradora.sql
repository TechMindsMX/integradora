INSERT INTO `flpmu_integrado` (`integrado_id`, `status`, `pers_juridica`) VALUES ('1', '1', '1');
...
INSERT INTO `flpmu_integrado_datos_bancarios` (`datosBan_id` , `integrado_id` , `banco_codigo` , `banco_cuenta` ,`banco_sucursal` ,`banco_clabe` ,`banco_file`) VALUES (NULL ,  '1',  '014',  '0141805663',  '0141',  '014180566389265712', NULL);

INSERT INTO  `integradb`.`flpmu_integrado_params` (`id` , `integrado_id` , `params`) VALUES (NULL ,  '1',  '1');