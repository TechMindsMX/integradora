...
<div class="div-formODC">
    <form id="form_admin_odd" class="form" method="post" action="index.php?option=com_adminintegradora&view=odcform&confirmacion=1&idOrden=<?php echo $orden->id; ?>">
        ...
        <div class="clearfix">&nbsp;</div>
<?php //TODO: Traer las cuentas bancarias de integradora ?>
        <div class="form-group">
...
<?php }else{ ?>
    <form id="confirmacion" method="post" action="index.php?option=com_adminintegradora&view=odclist&task=conciliar">
